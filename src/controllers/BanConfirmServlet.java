...
/**
 * Servlet implementation class BanConfirmServlet
 */
@WebServlet({ "/BanConfirmServlet", "/banconfirm" })
public class BanConfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BanConfirmServlet() {
        super();
